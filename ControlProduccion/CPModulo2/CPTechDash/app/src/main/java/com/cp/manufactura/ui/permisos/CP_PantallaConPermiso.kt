...
fun CP_PantallaConPermiso() {
    ...
    Column(
        ...
        if (permisoOtorgado) {
            ...
            Text("Permiso de camara de monitoreo concedido")
            Spacer(Modifier.height(8.dp))
            Text(
                "Aqui iria el componente de monitoreo de maquinaria",
            ...
            Spacer(Modifier.height(16.dp))
            Text("Se necesita acceso a la camara de monitoreo")
            Spacer(Modifier.height(8.dp))
            Button(onClick = {
        ...
        if (mostrarRacional) {
            AlertDialog(
                ...
                text  = {
                    Text(
                        "La camara de monitoreo es necesaria para supervisar la maquinaria. " +
