  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        Row(children: [
          Expanded(child: _TarjetaMetrica(titulo: 'Lineas', valor: '8', icono: Icons.dns, color: cs.primaryContainer)),
        ...
        Row(children: [
          ...
          const SizedBox(width: 8),
          Expanded(child: _TarjetaMetrica(titulo: 'Produccion', valor: '4.2 Ton', icono: Icons.wifi, color: cs.secondaryContainer)),
        ]),
      ],
    );
  }
...
class _PantallaLineas extends StatelessWidget {
  const _PantallaLineas();
    ...
    return ListView.builder(
      ...
      itemBuilder: (ctx, i) => Card(
        child: ListTile(
          ...
          title: Text('Linea Produccion 0${i + 1}'),
          subtitle: Text('10.0.2.${i + 10} · Activa'),
...
class _PantallaAlertas extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const alertas = [
      (servidor: 'Linea A', mensaje: 'Capacidad > 90%', nivel: 'CRITICO'),
      (servidor: 'Linea C', mensaje: 'Mantenimiento pendiente', nivel: 'AVISO'),
      (servidor: 'Linea B', mensaje: 'Reinicio inesperado', nivel: 'CRITICO'),
    ];
