...
export function CP_Paso3() {
  ...
  const [puerto, setPuerto] = useState<string>('502')
  ...
  function intentarConexion() {
    ...
    setUltimaConexion(
      `${host || 'maquina'}:${puerto} — intento #${intentosSilenciosRef.current}`
    )
  }

  return (
    <View style={styles.contenedor}>
      <Text style={styles.titulo}>Configurar Conexion PLC/SCADA</Text>

      <View style={styles.formulario}>
        <Text style={styles.etiqueta}>Host o IP del Controlador</Text>
        <TextInput
          ref={inputHostRef}
          style={styles.input}
          value={host}
        ...
        <Text style={styles.etiqueta}>Puerto de Comunicacion</Text>
        <TextInput
          ref={inputPuertoRef}
          style={styles.input}
          value={puerto}
      ...
      <Text style={styles.detalle}>Ultimo: {ultimaConexion}</Text>
