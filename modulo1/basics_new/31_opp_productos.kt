...
fun main() {
    ...
    CatalogoProductos.agregarProducto("Audifonos JBL 27\"", 59.99,  5, 2)
    CatalogoProductos.agregarProducto("Asus Vivobook",    600.99,  8, 3)
    ...
    for (productos in CatalogoProductos.listar()){
        println(productos)
