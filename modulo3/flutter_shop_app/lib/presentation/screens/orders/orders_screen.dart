              ...
              child: Builder(builder: (_) {
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(onPressed: ref.read(ordersProvider.notifier).refresh, child: const Text('Reintentar')),
                      ],
                    ),
                  );
                }
                  ...
                  return const Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 16),
                        Text('Sin pedidos', style: TextStyle(color: AppColors.textPrimary, fontSize: 18, fontWeight: FontWeight.bold)),
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return _OrderCard(order: order, onTap: () => context.push('/orders/${order.id}'));
                  },
                );
              }),
            ),
            ...
            Wrap(
              ...
              children: [
                ...order.items.take(3).map((item) => Container(
                      ...
                      child: Text('${item.quantity}× ${item.productName}', style: const TextStyle(color: AppColors.textSecondary, fontSize: 11), maxLines: 1, overflow: TextOverflow.ellipsis),
                    )),
                if (order.items.length > 3) Text('+${order.items.length - 3} más', style: const TextStyle(color: AppColors.textFaint, fontSize: 11)),
              ],
            ),
            const SizedBox(height: 12),
