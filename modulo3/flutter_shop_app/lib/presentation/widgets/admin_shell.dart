...
int adminSelectedIndex(String currentRoute) {
  ...
  final idx = adminNavItems.indexWhere(
    (item) => item.route != '/admin' && (currentRoute == item.route || currentRoute.startsWith('${item.route}/')),
  );
  return idx >= 0 ? idx : 0;
}
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            ...
            child: const Text('← Tienda', style: TextStyle(color: AppColors.accent, fontSize: 13)),
          ),
        ],
      ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          ...
                          style: const TextStyle(color: AppColors.onAccent, fontWeight: FontWeight.bold, fontSize: 20),
                        ),
                      ),
                    ),
                ...
                const Text('Panel de administración', style: TextStyle(color: AppColors.textSecondary, fontSize: 12)),
              ],
            ),
          ),
